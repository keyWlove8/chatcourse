...
public class JwtUtil {
     ...
     */
    public static String generateAccessToken(String userId, String username, String jti, String refreshJti) {
        // 设置Claims
        ...
        return generateToken(claims, ACCESS_TOKEN_EXPIRE_TIME, jti);
    }
     ...
     */
    public static String generateRefreshToken(String userId, String username, String refreshJti, String accessJti) {
        // 设置Claims
        Map<String, Object> claims = new HashMap<>();
        claims.put("userId", userId);
        claims.put("username", username);
        claims.put("type", "refresh");
        claims.put("accessJti", accessJti);
        return generateToken(claims, REFRESH_TOKEN_EXPIRE_TIME, refreshJti);
    }
     ...
     * @return Token字符串
     */
    public static String generateToken(Map<String, Object> claims, long expireTime, String jti) {
        Date now = new Date();
    ...
    public static TokenContext generateTokens(String userId, String username) {
        String jti = UUID.randomUUID().toString();
        String refreshJti = UUID.randomUUID().toString();
        String accessToken = generateAccessToken(userId, username, jti, refreshJti);
        String refreshToken = generateRefreshToken(userId, username, refreshJti, jti);
        ...
        tokenContext.setRefreshJti(jti);
        tokenContext.setAccessJti(jti);
        return tokenContext;
    }
}
